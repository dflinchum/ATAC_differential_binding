...
JN_negDoxpeaks <- JN_DEsamples[JN_DEsamples$FDR<0.05 & JN_DEsamples$Fold > 0,c(2,3,4,13,10,11,12)]
JN_posDoxpeaks <- JN_DEsamples[JN_DEsamples$FDR<0.05 & JN_DEsamples$Fold < 0,c(2,3,4,13,10,11,12)]
...
JN_allpeaksAnno <- annotatePeak("JN_NP_allpeaks.bed", TxDb=txdb, genomicAnnotationPriority = c("Promoter", "5UTR", "3UTR", "Exon", "Intron", "Downstream", "Intergenic"), tssRegion=c(-3000,3000), annoDb="org.Hs.eg.db")
